                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="{{ url('check-out') }}/{{ $pesanan_detail->id }}" method="post">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin hapus pesanan?')"><i class="fa fa-trash"></i></button>
                        </form>
                        </td>
                    </tr>
                    @endforeach
                    <tr>
                        ...
                        <td>                           
                            <a href="{{ url('konfirmasi-check-out') }}" class="btn btn-success" onclick="return confirm('Anda Yakin Akan Check Out?')"><i class="fa fa-shopping-cart"></i>Check Out
                        </a>
                    </td>
                    </td>
                    </tr>
